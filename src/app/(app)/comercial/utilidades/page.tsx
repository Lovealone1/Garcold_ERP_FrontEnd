    ...
    return (
        <div className="relative rounded-xl border shadow-sm" style={{ background: OUTER_BG, borderColor: BORDER }}>
            ...
            <div className="hidden sm:block mx-1.5 my-2 rounded-md px-3 py-3" style={{ background: INNER_BG }}>
                <div className="grid items-center gap-3" style={{ gridTemplateColumns: "1fr 160px 160px 136px" }}>
            ...
            {/* Móvil */}
            <div
                className="sm:hidden relative mx-2.5 my-3 rounded-md px-3 py-2 min-h-[84px]"
                style={{ background: INNER_BG }}
            >
                {/* acción libre centrada */}
                <button
                ...
                <div className="min-w-0 pr-12">
                    <div className="text-sm font-extrabold tracking-wide truncate">
                        {customer || "…"}
                    </div>
    ...
    return (
        <>
            <div className="app-shell__frame" style={frameVars}>
                ...
                <div
                    className="rounded-xl border flex-1 min-h-0 flex flex-col overflow-hidden"
                ...
                >
                    ...
                    {/* Paginación: pegada al borde inferior del contenedor, sin línea divisoria */}
                    <div className="shrink-0 px-3 pb-2 pt-1 flex flex-wrap gap-3 items-center justify-between">
                        ...
                        <div className="text-sm text-tg-muted">1 - {to} de {total} {total === 1 ? "registro" : "registros"}</div>
                    </div>
                </div>
            </div>
