...
import { buildFacturaPreviewUrl, descargarFacturaPdf } from "@/services/sales/facturas.api";
        ...
        <div className="app-shell__frame" style={frameVars}>
            ...
            {openPreview && (
                <div
                    ...
                    onClick={(e) => {
                        if (e.target === e.currentTarget) setOpenPreview(false);
                    }}
                >
                    <div className="w-[1100px] max-w-[95vw] rounded-xl border border-tg bg-[var(--panel-bg)] shadow-2xl overflow-hidden">
                        {downloading && (
                            <LinearProgress
                                ...
                                sx={{
                                    ...
                                    "& .MuiLinearProgress-bar": { backgroundColor: "var(--tg-primary)" }
                                }}
                            />
                        )}
                        ...
                        <div className="flex items-center justify-between border-b border-tg px-4 py-3">
                            ...
                            <button onClick={() => setOpenPreview(false)} className="p-1 rounded hover:bg-black/10 dark:hover:bg-white/10">
                                ✕
                            </button>
                        </div>
                        ...
                        <div className="grid grid-cols-[minmax(0,1fr)_320px] gap-4 p-4">
                            ...
                            <aside className="flex flex-col gap-3">
                                ...
                                <button onClick={onAbrirEnPestana} disabled={downloading} className="h-10 rounded-md border border-tg px-4 text-sm disabled:opacity-60">
                                    Abrir en nueva pestaña
                                </button>

                                <p className="text-sm text-tg-muted">Vista reducida (A4). Para imprimir usa “Abrir en nueva pestaña”.</p>
                            </aside>
                        </div>
                    </div>
                </div>
