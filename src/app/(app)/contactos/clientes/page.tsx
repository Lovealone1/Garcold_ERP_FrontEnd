...
const actionBtn =
  "tap-target h-8 w-8 grid place-items-center rounded-full hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-tg-primary";
    ...
    <div className="relative rounded-xl border shadow-sm" style={{ background: OUTER_BG, borderColor: BORDER }}>
      ...
      <div className="hidden sm:block mx-1.5 my-2 rounded-md px-3 py-2.5" style={{ background: INNER_BG }}>
        ...
        >
          ...
          <div className={`${pill} font-semibold`} style={{ background: PILL_BG, borderColor: BORDER }}>
            {money.format(saldo)}
          </div>
