...
import NuevaTransaccionModal from "@/features/transacciones/NuevaTransaccionModal";
...
export default function TransaccionesPage() {
    ...
    // filas listas para la UI (items ya traen banco como string)
    const viewRows = useMemo(() => items, [items]);
    ...
    // crear (invocado por el modal)
    async function handleCreateSubmit(payload: TransaccionCreate) {
        try {
