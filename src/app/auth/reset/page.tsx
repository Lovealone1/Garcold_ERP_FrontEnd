...
export default function ResetPasswordPage() {
    ...
    const disabled = saving || !pwd || !confirm || pwd !== confirm || pwd.length < 8;

    return (
        <div className="max-w-md mx-auto p-6 space-y-4">
            <h1 className="text-xl font-semibold" style={{ color: "var(--tg-fg)" }}>
            ...
            <div className="space-y-3">
                ...
                <button
                    ...
                    style={{ background: "var(--tg-primary)", color: "var(--tg-primary-fg)", opacity: disabled ? 0.6 : 1 }}
                >
