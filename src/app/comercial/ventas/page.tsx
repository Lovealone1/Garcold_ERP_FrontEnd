                                            ...
                                            <td className="px-2 py-2">
                                                <div className="flex items-center justify-center gap-1">
                                                    ...
                                                    <Tooltip title="Descargar factura" arrow>
                                                        <IconButton size="small" aria-label="descargar factura" onClick={() => { }} sx={{ color: "var(--tg-primary)", borderRadius: "9999px", "&:hover": { backgroundColor: "color-mix(in srgb, var(--tg-primary) 22%, transparent)" } }}>
