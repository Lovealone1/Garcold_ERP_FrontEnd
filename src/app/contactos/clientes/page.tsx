...
import ClienteCreate, { type NuevoCliente } from "@/features/clientes/ClienteCreate";
...
export default function ClientesPage() {
  ...
  useEffect(() => { fetchPage(); }, [page, size, q]);
  ...
  async function handleCreate(data: NuevoCliente) {
    setCreating(true);
    try {
