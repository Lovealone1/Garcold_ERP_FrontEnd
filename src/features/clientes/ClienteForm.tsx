// features/clientes/ClienteForm.tsx
"use client";
...
type CreateProps = {
    intent: "create";
    onSubmit: (data: ClienteCreate) => Promise<void> | void;
    defaults?: Partial<ClienteCreate>;
};
type EditProps = {
    intent: "edit";
    onSubmit: (data: ClienteUpdate) => Promise<void> | void;
    defaults?: Partial<ClienteUpdate>;
};
...
export default function ClienteForm(props: Props) {
    ...
    const [form, setForm] = useState<FormState>(() => ({
        ...
        direccion: "",
        ciudad: "",
        saldo: (props.defaults as any)?.saldo ?? 0,
    ...
    const doSubmit = async (e?: FormEvent) => {
        ...
        if (isCreate) {
            await (onSubmit as CreateProps["onSubmit"])(base as unknown as ClienteCreate);
        } else {
            await (onSubmit as EditProps["onSubmit"])(base as unknown as ClienteUpdate);
        }
    };
