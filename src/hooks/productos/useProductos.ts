    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            for (; ;) {
                ...
                const pagesLoaded =
                    qc.getQueryData<InfiniteData<ProductPageDTO>>(key)?.pages?.length ?? 0;
